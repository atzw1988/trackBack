<template>
  <div class="home">
    ...
    <div class="pages" ref="pages">
      <div class="need">
        <div class="content">
          <div class="title">富邦吃货卫士健康保险定制版免责事项</div>
          <div class="des">为了保证被保险人权益不受影响，请完整阅读以下内容</div>
        </div>
        <div class="list" ref="need">
          <div class="imgList">
            <img class="img" src="../../assets/chihuo/chihuomianze1.png" mode="widthFix">
            <img class="img" src="../../assets/chihuo/chihuomianze2.png" mode="widthFix">
            <img class="img" src="../../assets/chihuo/chihuomianze3.png" mode="widthFix">
          </div>
        </div>
