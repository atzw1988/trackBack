    ...
    <div class="pages" ref="pages">
      <div class="need">
        ...
        <div class="list" ref="need">
          <div class="imgList">
            <img class="img" src="../../assets/zhuzhai/zhuzhaishouhushenxuzhi1.png" mode="widthFix">
            <img class="img" src="../../assets/zhuzhai/zhuzhaishouhushenxuzhi2.png" mode="widthFix">
            <img class="img" src="../../assets/zhuzhai/zhuzhaishouhushenxuzhi3.png" mode="widthFix">
          </div>
        </div>
